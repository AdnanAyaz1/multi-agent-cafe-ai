...
const FEATURES = [
  {
    icon: (
      <svg className="w-5 h-5 text-[#1fe19e]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Quick onboarding process',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#ffd79f]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative z-10 flex-col justify-between p-12">
        <div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <p
              className="text-[11px] text-[#00d2ff] uppercase tracking-[0.2em] font-semibold"
          ...
          <p className="text-lg text-[#859399] leading-relaxed max-w-md">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#859399]">{feature.description}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="flex-1 relative z-10 flex flex-col p-8 lg:p-12">
        ...
        <div className="lg:hidden flex items-center gap-3 mb-8">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#00d2ff] to-[#1fe19e] flex items-center justify-center shadow-lg shadow-[#00d2ff]/25">
              <span className="text-[#003543] font-bold text-sm" style={{ fontFamily: 'var(--font-montserrat)' }}>
                C
              </span>
            </div>
