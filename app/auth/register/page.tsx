...
const FEATURES = [
  {
    icon: (
      <svg className="w-5 h-5 text-[#c8a070]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    icon: (
      <svg className="w-5 h-5 text-[#e07850]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    icon: (
      <svg className="w-5 h-5 text-[#f5dcc8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
