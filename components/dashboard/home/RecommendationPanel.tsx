...
import type { RecommendationPanelProps } from '@/types/dashboard';

export function RecommendationPanel({ summary, confidence, actions }: RecommendationPanelProps) {
  return (
    <Card overflow className="p-0">
      <div className="p-8 bg-gradient-to-br from-accent/15 to-accent/8 border-b border-border">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center">
            <Lightbulb className="size-5 text-secondary" />
          </div>
          <div>
            <CardHeading>Today&apos;s Top Recommendation</CardHeading>
        ...
        <div className="flex items-center gap-3 mt-3">
          ...
          <span className="text-sm font-bold text-secondary">{confidence}% confidence</span>
        </div>
      </div>
