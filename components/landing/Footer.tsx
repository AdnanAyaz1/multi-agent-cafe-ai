      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed max-w-[200px]" style={{ color: "rgba(160, 152, 144, 0.75)" }}>
          ...
          {Object.entries(FOOTER_LINKS).map(([category, links]) => (
            <div key={category}>
              <p className="text-[10px] font-mono uppercase tracking-[0.2em] mb-5"
                style={{ fontFamily: "var(--font-jetbrains-mono)", color: "rgba(160, 152, 144, 0.65)" }}>
                {category}
              </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4"
          ...
          <span className="text-xs" style={{ color: "rgba(160, 152, 144, 0.6)" }}>
          ...
          <div className="flex items-center gap-4">
            <span className="transition-colors duration-300 cursor-pointer hover:text-white"
              style={{ color: "rgba(160, 152, 144, 0.55)" }}>
