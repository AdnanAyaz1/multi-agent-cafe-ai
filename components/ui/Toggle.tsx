...
export function Toggle({ enabled, onToggle, color = '#e07850', size = 'md' }: ToggleProps) {
  ...
  return (
    <button
      ...
      style={enabled ? { background: `${color}30`, border: `1px solid ${color}40` } : { border: '1px solid #2a2725' }}
    >
      <div
