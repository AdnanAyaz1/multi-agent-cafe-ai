...
export const HOW_IT_WORKS_STEP_ICONS: ReactElement[] = [
...
export const AUTH_FEATURE_ICON_LIST: ReactElement[] = [
...
export const MENU_CATEGORY_ICON_MAP: Record<string, LucideIcon> = { Coffee, IceCreamBowl, Sandwich, CakeSlice };

export const CHECKOUT_BADGES = ['256-bit SSL', 'PCI Compliant', 'Cancel anytime'] as const;

export const HELP_QUICK_LINKS = [
  { iconKey: 'BookOpen' as const, label: 'Docs', href: '#' },
  { iconKey: 'MessageSquare' as const, label: 'Feedback', href: '#' },
  { iconKey: 'Mail' as const, label: 'Contact', href: 'mailto:support@cafepromo.ai' },
] as const;
